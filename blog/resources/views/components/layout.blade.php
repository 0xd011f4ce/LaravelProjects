...
<head>
    ...
    <title>@isset ($doctitle) {{ $doctitle }} | OurApp @else OurApp @endisset</title>
...
<body>
    ...
    @auth
        <div id="chat-wrapper" class="chat-wrapper shadow border-top border-left brder-right"
            data-username="{{auth ()->user ()->username}}"
            data-avatar="{{auth ()->user ()->avatar}}"></div>
    @endauth
